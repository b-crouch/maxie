...
class AdaptedViTMAEForPreTraining(nn.Module):
    ...
    def unpatchify(self, patchified_pixel_values):
        ...
        # VitMAE returns patchified logits with shape (N, n_patches, patch_size**2 * C)
        # Here, N is the number of patches generated by `maxie`'s Patchify transform (performed before passing data through model)
        # C is the number of input channels; C = 1 for LCLS data
        # The following code inverts VitMAE's patchification to produce data with shape (N, C, img_size, img_size)
        num_channels = 1
